...
const FilterCategories = {
  ...
  priceRanges: ["Accepts Insurance", "10,000 and up"],
...
type FilterSelections = {
  [K in keyof typeof FilterCategories]: string[];
};
...
export default function FilterComponent() {
  ...
  const getSelectedCount = (category: keyof FilterSelections): number => {
      ...
      <div className="flex items-center gap-2">
        ...
        >
          {Object.entries(FilterCategories).map(([category, options]) => {
            const categoryKey = category as keyof FilterSelections;
